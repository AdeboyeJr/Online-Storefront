...
if (mysqli_num_rows($get_item_res) < 1) {
    ...
    // make breadcrubm trail & display of item
    $display_block .= <<<END_OF_TEXT
    <p><em>You are viewing:</em><br>
    <strong><a href="seestore.php?cat_id=$cat_id">$cat_title</a>
    &gt; $item_title</strong></p>
    <div style="float: left;"><img src="images/$item_image" alt="$item_title"></div>
    ...
    // get colors
    $get_color_sql = "SELECT item_color FROM store_item_color WHERE item_id = '".$safe_item_id."' ORDER BY item_color";
